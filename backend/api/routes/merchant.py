...
from backend.models.merchant_schemas import MerchantCreate, MerchantResponse, MerchantUpdate
from backend.services.merchant_service import MerchantService
...
def create_supplier(data: MerchantCreate):
    try:
...
def update_supplier(supplier_id: int, data: MerchantUpdate):
    try:
